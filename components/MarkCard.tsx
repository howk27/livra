...
const styles = StyleSheet.create({
  ...
  compactFraction: { fontSize: fontSize['2xs'], lineHeight: 13, flexShrink: 0 },
  ...
  metaText: { fontSize: fontSize['2xs'], lineHeight: 12 },
  goalSubtitle: { fontFamily: fonts.sans, fontSize: fontSize.xs, lineHeight: 14 },
  ...
  actionText: { fontSize: fontSize.display, fontWeight: fontWeight.bold, lineHeight: 26, includeFontPadding: false },
