...
export type MomentType =
  ...
  | 'comeback' // spec §3 (2026-07-24) — ends-a-gap acknowledgment, outranks every postLog pick
  | 'identity'; // spec §2 (2026-07-24) — earned-identity fact/claim, once-ever per milestone
