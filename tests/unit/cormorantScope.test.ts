...
const SANCTIONED = new Set<string>([
  ...
  // Weekly Story card 2026-09-16 (replaced the letter-crop card): the review
  // as a shareable image is the same moments-that-matter surface (serif
  // archetype name + wordmark), mounted only inside the share sheet, never chrome.
  'components/WeeklyStoryCard.tsx',                 // weekly story share card
]);
